...
Temp = AnalogIn(mcp, MCP.P1) # Input channel for temperature component, channel 1 
LDR = AnalogIn(mcp, MCP.P2) # Input channel for LDR component, channel 2 
BTN=17 # GPIO pin the button is connected to on the Pi 
index = 0 # incrementor for the button pressed 
sample = [10, 5, 1] # different sample rates 
rate = sample[index] # period for the sample rate chosen 
